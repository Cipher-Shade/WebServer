...
export const Message = () => {
    ...
    const fetchLatestSensorData = async () => {
      try {
        ...
        const distanceResponse = await axios.get(
          "http://192.168.100.68:4001/api/v1/ultrasonicsensor/latest"
        );
        ...
        const flexResponse = await axios.get(
          "http://192.168.100.68:4001/api/v1/flexsensor/latest"
        );
        ...
        // Fetch gyro data
        const gyroResponse = await axios.get(
  ...
  return (
    <div className="text-white border shadow-xl card bg-primary-variant w-96 border-primary-default">
      <div className="items-center text-center card-body">
        <h1 className="text-2xl italic capitalize card-title">{message}</h1>
